function worldSwimmingRecord(input){
    ...
    let seceondsPerMeter = Number(input[2]);
    let timeIvancho = seceondsPerMeter * metres;
    let resistance = (Math.floor(metres/15) * 12.5);
    let endTime = timeIvancho + resistance;
    if (endTime < secondsRecord){
        console.log(`Yes, he succeeded! The new world record is ${(endTime.toFixed(2))} seconds.`);
    }else{
        console.log(`No, he failed! He was ${(endTime - secondsRecord).toFixed(2)} seconds slower.`);
    }
