function solve(input){
    ...
    let cake=rent*0.2
    let drinks=cake*0.65
    let animator=rent/3

    let budget= rent+cake+drinks+animator
    console.log(budget);
}
// За рожденният ден на дъщеря си Людмила е решила да организира парти, на което да покани 
// всичките ѝ съученици. За целта е решила да наеме развлекателна зала за деца, чийто наем ще 
// получите като вход от конзолата. 
