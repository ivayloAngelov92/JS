...
const endpoints={
    ...
    byOfferId: offerId=>`/data/likes?where=bookId%3D%22${offerId}%22&distinct=_ownerId&count`,
    byOfferIdandUserId: (offerId,userId)=>`/data/likes?where=bookId%3D%22${offerId}%22%20and%20_ownerId%3D%22${userId}%22&count`
}
